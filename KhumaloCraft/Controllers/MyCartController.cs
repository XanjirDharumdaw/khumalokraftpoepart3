...
namespace KhumaloCraft.Controllers
{
    ...
    public class MyCartController : Controller, IMyCartController
    {
        ...
        public IActionResult AddToCart(int productId)
        {
            ...
            var product = new Product
            {
                ...
                Price = 100.0M * productId,
                ImageUrl = $"/images/product{productId}.jpg"
            };

            var cartItem = Cart.Find(ci => ci.Product.Id == productId);
            if (cartItem != null)
            {
                cartItem.Quantity++;
            }
        ...
        [HttpPost]
        public IActionResult FakeCheckout(string fullName, string email, string phone, decimal totalAmount)
        {
            // Simulate processing logic (logging, notifications, etc.)
            // For demonstration purposes, just redirect and show a message
            TempData["Message"] = "Thank you for your order! This is a fake checkout.";
